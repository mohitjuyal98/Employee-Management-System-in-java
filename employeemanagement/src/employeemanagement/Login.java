...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBounds(new java.awt.Rectangle(390, 100, 300, 300));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Logo transparent back.png"))); // NOI18N
    ...
    if (evt.getSource() == jButton1)
      {
        try
        {
           ...
           Connection con =DriverManager.getConnection("jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=f:/project/m.mdb;DriverID=22;READONLY=true)","", "");
           try
           {
             Statement st = con.createStatement();
             ResultSet rs = st.executeQuery("SELECT * FROM security WHERE username='" + jTextField2.getText() +"' and password='" + jPasswordField1.getText() + "'");
             if (rs.next())
             {
                JOptionPane.showMessageDialog(null,"Welcome in Employee Management System","login",JOptionPane.INFORMATION_MESSAGE); 
               
                     Login frm=new Login();
 
 
                   frm.setVisible(false);   frm.hide();
                mdi f1=new mdi();
                           f1.setVisible(true);
                           f1.show();
